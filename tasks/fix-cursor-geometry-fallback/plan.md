...
- R7: testes cobrem cursor dentro/fora, range sobre cursor, cursor sobre frame, limites, entradas inválidas e múltiplos monitores.
...
A contenção compara valores globais diretamente e não normaliza, arredonda nem limita coordenadas. Assim, frames e cursores com `x/y` negativos continuam válidos.

## 3. TASKS

- [x] T1 [LOW] Registrar evidência causal e draft SDD.
- [ ] T2 [LOW] Executar análise dual do plano.
- [ ] T3 [LOW] Sintetizar o contrato final.
