...
- O handshake de readiness nasce em `useLayoutEffect`, depois do commit React, e só aceita ACK após a main thread aplicar o estado nativo. Tentativas são idempotentes, limitadas por quantidade e timeout, param no primeiro ACK e registram a exaustão.
