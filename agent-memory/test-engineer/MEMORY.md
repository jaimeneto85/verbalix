...
- A suíte Rust possui 136 testes, incluindo readiness pós-pin, feedback tipado, toolbar/replace/restore bloqueáveis, leases antes/depois do claim, histórico detached e insert/list, identidade AX e a matriz de fallback geométrico.
